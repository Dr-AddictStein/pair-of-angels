...
const Home = () => {
    return (
        <div className="animate-fade-in-down h-screen bg-cover bg-center relative" 
            ...
            <div className="absolute top-[20%] right-[5%] md:top-[35%] md:right-[0%] lg:top-[35%] lg:right-[0%] xl:right-[5%] 2xl:right-[15%] text-white leading-[1.2] md:leading-[1.4] lg:leading-[1.6]">
                ...
                <div className="flex flex-col md:flex-row justify-start mt-4 md:mt-6 lg:mt-8 gap-4">
                    <Link className='transition duration-200 bg-[#b00000] rounded-full px-6 py-3 md:px-8 md:py-4 text-lg md:text-xl lg:text-2xl font-bold hover:bg-black' to='/services'>
                        Explore Now!
                    </Link>
                    <Link className='transition duration-200 bg-[#b00000] rounded-full px-6 py-3 md:px-8 md:py-4 text-lg md:text-xl lg:text-2xl font-bold hover:bg-black' to='/services'>
                        Our Services!
